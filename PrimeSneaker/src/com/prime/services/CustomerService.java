...
public class CustomerService {
   ...
   public ArrayList<Order> getOrderHistory() throws SQLException{
       ArrayList<Order> listOrder = new ArrayList<>();
       String query = "SELECT Customer.full_name,"
               + " order_id,"
               + " user_id,"
       ...
       try {
           ...
           while (result.next()) {               
               ...
               order.setCustomerName(result.getString("full_name"));
               order.setOrderId(result.getInt("order_id"));
               order.setUpdate_at(result.getDate("updated_at"));
               order.setTotalCost(result.getLong("total_cost"));
