...
//            System.out.println(tomorrow.toString());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CẬP NHẬT VOUCHER");
...
//            System.out.println(voucher.toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateVoucher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateVoucher().setVisible(true);
            }
        });
    }
